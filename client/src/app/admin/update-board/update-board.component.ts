...
import { UserService } from "src/app/admin/users-view/services/user.service";
import { ConfirmDialogRequest } from "src/app/core/interface/core.interface";
import { NotificationService } from "src/app/core/services/notification.service";
import { BoardDetailsResponse } from "src/app/modules/board-details/interface/board-details.interface";
...
import { CardService } from "src/app/modules/board-details/share/card.service";
import { ColumnService } from "src/app/modules/board-details/share/column.service";
...
import { User } from "../users-view/users-view.component";
...
export class UpdateBoardComponent implements OnInit {
  ...
  async ngOnInit() {
    this.users = await this.userService.getCustomer();
  }

  async updateBoardList(user: User) {
    console.log(user);
    this.boards = await this.userService.findBoardsByUsername(user.username);
    console.log(this.boards);
  }

  async updateBoardView(board: Boards) {
    console.log(board);
    const boardId = JSON.parse(JSON.stringify(board)).id;
    console.log(boardId);
    this.id = boardId;
    this.spinner.show();
    // this.id = board.id;
